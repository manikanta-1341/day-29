                                            ...
                                            <ul class="navbar-nav ml-auto">
                                                <li class="nav-item dropdown">
                                                    <a class="nav-link dropdown-toggle" href="##" id="navbarDropdown"
                                                        ...
                                                        aria-expanded="false" onClick={() => dropDown()}>
                                                        Dropdown
                                                    </a>
                                                    {dropdown?<div class="dropdown-menu dropdown-menu-right animated--grow-in show"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <nav class="navbar navbar-expand navbar-light bg-light mb-4">
                                            ...
                                            <ul class="navbar-nav ml-auto">
                                                <li class="nav-item dropdown show">
                                                    <a class="nav-link dropdown-toggle" href="##" id="navbarDropdown"
                                                        role="button" data-toggle="dropdown" aria-haspopup="true"
                                                        aria-expanded="false" onClick={() =>dropDown2()}>
                                                        Dropdown
                                                    </a>
                                                    {dropdown2?<div class="dropdown-menu dropdown-menu-right animated--fade-in show"
                                                        aria-labelledby="navbarDropdown">
                                                        <a class="dropdown-item" href="##">Action</a>
                                                        <a class="dropdown-item" href="##">Another action</a>
                                                        <div class="dropdown-divider"></div>
                                        ...
                                        <div class="dropdown mb-4">
                                            <button class="btn btn-primary dropdown-toggle" type="button"
                                                ...
                                                aria-expanded="false" onClick ={() =>dropDown3()}>
                                                Dropdown
                                            </button>
                                            {dropdown3?<div class="dropdown-menu animated--fade-in show"
